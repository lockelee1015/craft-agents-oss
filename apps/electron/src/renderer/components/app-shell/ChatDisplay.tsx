                ...
                <AnimatePresence mode="wait" initial={false}>
                  ...
                  {compactMode && turns.length === 0 && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center select-none gap-1 pointer-events-none">
                      <span className="text-sm text-muted-foreground">{te('What would you like to change?')}</span>
                      <span className="text-xs text-muted-foreground/50">{te("Just describe it - I'll handle the rest")}</span>
                    </div>
                  )}
