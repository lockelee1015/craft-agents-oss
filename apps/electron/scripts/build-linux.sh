...
echo "=== Building MoonCake AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: MoonCake-x86_64.AppImage or MoonCake-aarch64.AppImage
BUILT_APPIMAGE_NAME="MoonCake-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: MoonCake-x64.AppImage, MoonCake-arm64.AppImage
APPIMAGE_NAME="MoonCake-${ARCH}.AppImage"
